<?php
/* examresults-par.php — Parent-facing exam results view for their children */
...
// Retrieve results for students linked to this parent via email
...
<title>Results - Student Management Parent Portal</title><link rel="icon" href="images/user.png"><?php include_once 'includes/header.php';?></head><body>
