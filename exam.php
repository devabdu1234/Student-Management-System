<?php
/* exam.php — Schedule and manage examination/assessment sessions */
...
// Process form submission to schedule a new exam
...
// Retrieve all exams with subject title for display
